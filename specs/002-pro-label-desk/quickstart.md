...
- rendering equality: runs joined equal `text` for the en-US and de-DE fixtures (SC-003)
...
| Q4 | Open the language picker with the UI in Lithuanian | It offers en-US and de-DE only; the default is en-US (R1) |
